...
Development installation instructions available [here](http://blaze.pydata.org/docs/dev/install.html).  Quick usage available [here](http://blaze.pydata.org/docs/dev/quickstart.html).
